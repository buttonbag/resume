export default [
    {
        ...
        year: '2021 - present',
        description:
            'Building reusable, scalable, and modular CSS to use on pages and elements with Bootstrap. Taking existing HTML/CSS and refactoring into cleaner, optimized code without changing external behavior.',
    },
    {
        position: 'Front End Developer',
        name: 'Ogilvy & Mather',
